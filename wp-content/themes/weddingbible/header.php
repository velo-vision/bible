...
<head>
	...
	<link type="text/css" rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/bootstrap.css"  media="screen,projection"/>

	<script src="//ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>

	<script src="<?php bloginfo('template_url'); ?>/js/jquery.bxslider.min.js"></script>

	<link type="text/css" rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/jquery.bxslider.css"  media="screen,projection"/>
...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/tiksluscarousel.js"></script>

<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/tiksluscarousel.css" />
...
<div class="wide-nav <?php echo $flatsome_opt['nav_position_color']; ?> <?php if($flatsome_opt['nav_position'] == 'bottom_center') {echo 'nav-center';} else {echo 'nav-left';} ?>">
	...
	<div class="row">
		...
		<ul id="site-navigation" class="header-nav">
              ...
              <li><a href="https://www.facebook.com/theweddingboard/" target="_blank" rel="nofollow" class=""><span class="icon-facebook redes_test"></span></a></li>
              <li><a href="https://twitter.com/TheWeddingBoard" target="_blank" rel="nofollow" class=""><span class="icon-twitter redes_test"></span></a></li>
              <li><a href="https://www.pinterest.com/twboard/" target="_blank" rel="nofollow" class=""><span class="icon-pinterest redes_test"></span></a></li>
              <li><a href="https://www.instagram.com/the_weddingboard/" target="_blank" rel="nofollow" class=""><span class="icon-instagram redes_test"></span></a></li>

              <li>

				<form method="get" id="searchform" class="searchform hidden-sm display-serch" action="http://twblog.com.mx/" role="search">

				<input type="search" class="field" name="s" value="" id="s" placeholder="">

				<button class="button secondary postfix"><i class="icon-search" style="margin-left:-40px;"></i></button>
