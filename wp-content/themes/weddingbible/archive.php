...
<div class="col-xs-12 col-md-12 col-lg-12" style="padding: 0px; margin: 0px;">
  <?php if(is_category("9")){?><!-- planning -->
         <div class="col-sm-12 col-md-12 col-lg-12 categoriafondo9">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">planning & advice</span>
             </h3>
           </div>
      <?php }elseif(is_category("4")){ ?> <!-- travel -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">travel</span>
             </h3>
           </div>
      <?php }elseif(is_category("8")){ ?> <!-- inspiration -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">inspiration & ideas</span>
             </h3>
           </div>
      <?php }elseif(is_category("6")){ ?> <!-- fashion -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">fashion & beauty</span>
             </h3>
           </div>
      <?php }elseif(is_category("7")){ ?> <!-- home and merries -->
         <div class="col-sm-12 col-md-12 col-lg-12 categoriame">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">home & marriage</span>
             </h3>
           </div>
      <?php }elseif(is_category("14")){ ?>
         <div class="col-sm-12 col-md-12 col-lg-12 categoriafondo8">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">antes de tu boda</span>
             </h3>
           </div>
      <?php }elseif(is_category("15")){ ?>
         <div class="col-sm-12 col-md-12 col-lg-12 categoriafondo8">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">el gran día</span>
             </h3>
           </div>
      <?php }elseif(is_category("16")){ ?>
         <div class="col-sm-12 col-md-12 col-lg-12 categoriafondo8">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">servicios para tu boda</span>
             </h3>
           </div>
      <?php }elseif(is_category("17")){ ?>
         <div class="col-sm-12 col-md-12 col-lg-12 categoriafondo8">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">tips</span>
             </h3>
           </div>
      <?php }elseif(is_category("18")){ ?>
         <div class="col-sm-12 col-md-12 col-lg-12 categoriafondo">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">despedidas</span>
             </h3>
           </div>
      <?php }elseif(is_category("19")){ ?>
         <div class="col-sm-12 col-md-12 col-lg-12 categoriafondo">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">destinos para tu boda</span>
             </h3>
           </div>
      <?php }elseif(is_category("20")){ ?>
         <div class="col-sm-12 col-md-12 col-lg-12 categoriafondo">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">honeymoon</span>
             </h3>
           </div>
      <?php }elseif(is_category("21")){ ?>
         <div class="col-sm-12 col-md-12 col-lg-12 categoriafashion">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">belleza y salud</span>
             </h3>
           </div>
      <?php }elseif(is_category("22")){ ?>
         <div class="col-sm-12 col-md-12 col-lg-12 categoriafashion">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">tendencias</span>
             </h3>
           </div>
      <?php }elseif(is_category("23")){ ?>
         <div class="col-sm-12 col-md-12 col-lg-12 categoriafashion">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">vestidos de novia</span>
             </h3>
           </div>
      <?php }elseif(is_category("24")){ ?>
         <div class="col-sm-12 col-md-12 col-lg-12 categoriame">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">hogar</span>
             </h3>
           </div>
      <?php }elseif(is_category("25")){ ?>
         <div class="col-sm-12 col-md-12 col-lg-12 categoriame">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 1% 0 0 0 ;">
             <h3 class="section-title clearfix title_center ">
               <span class="titulo-categorys">recién casados</span>
             </h3>
           </div>
      <?php }
...
<div class="col-xs-12 col-md-12 col-lg-10 col-lg-offset-10 col-lg-offset-1" style="margin: 0% 0;">
  <?php $cont=1;
      ...
      <div class="col-sm-12 col-md-12 col-lg-12 sin margenrayas">
       ...
       <!-- Img Corazon -->
        <div class="col-sm-12 col-md-12 img-categoria">
          <img src="<?php bloginfo('template_url'); ?>/img/corazon.png"  alt="wedding bible" width="15%">
        </div>
        <!--derecho-->
    <?php }else{ ?>
...
<?php } $cont++;
  endwhile; ?>
        <div class="col-sm-12 col-md-12 col-lg-12 pagination">
